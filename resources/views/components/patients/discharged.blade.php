        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> <a><i class="fas fa-building"></i> Discharged </a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        @if(count($patients) != 0)
                            ...
                            <tr>
                                ...
                                <td class="patient_actions">
                                    <!-- ADMIT PATIENT -->
                                    <a href="{{ route('admit_patient', ['patient_id'=>$patient->id]) }}"  class="btn btn-sm btn-outline-success"><i class="fas fa-eject"></i> ADMIT</a>
