  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-green"><i class="fas fa-procedures"></i> Amitted</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> <a><i class="fas fa-procedures"></i> Admitted </a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content-body" style="margin:10px;">
        <div class="card">
            ...
            <div class="card-header">
                    ADMITTED ({{ count($patients->where('status', 'admitted')) }})
