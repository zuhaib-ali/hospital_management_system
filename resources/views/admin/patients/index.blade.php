        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a href="{{ route('admin.index') }}"><i class="fas fa-home"></i> Home </a></li>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#add_new_patient_modal"> <i class="fas fa-plus"></i></button>    
                    <form class="form" method="POST" action="{{ route('admin.add_new_patient') }}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    @if(count($patients) != 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="patient_actions">
                                                ...
                                                @if($patient->status != "admitted")
                                                    <a href="{{ route('admin.admit_patient', ['patient_id'=>$patient->id]) }}" title="admit" class="btn btn-sm btn-outline-success"><i class="fas fa-procedures"></i></a>
                                                @else
                                                    <a href="{{ route('admin.discharge_patient', ['patient_id'=>$patient->id]) }}" title="discharge"  class="btn btn-sm btn-outline-dark"><i class="fas fa-walking"></i></a>
                                                @endif
                                                ...
                                                <!-- DELETE PATIENT -->
                                                <a href="{{ route('admin.delete_patient', ['patient_id'=>$patient->id]) }}" title="delete" class="btn btn-sm btn-outline-danger" style="color:red;"><i class="fas fa-trash"></i></a>
                                            </td> 
                                        </tr>
                                        @endforeach
                                    @endif
