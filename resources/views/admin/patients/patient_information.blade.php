        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('admin.patients') }}" class="text-red"> <i class="fas fa-user-md"></i>  Patients</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="{{ route('admin.update_patient') }}" method="POST">
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <select name="hospital" id="" class="form-control">
                            <option value="" selected disabled hidden>-- SELECT HOSPITAL BRANCH --</option>
                            @foreach($hospitals as $hospital)
                              <option value="{{ $hospital->id }}" @if($patient->hospital_id == $hospital->id) selected @endif>{{ $hospital->city }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
