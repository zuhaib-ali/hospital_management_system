        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.index') }}" class="text-red"> <i class="fas fa-home"></i>  Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('admin.doctors') }}" class="text-red"> <i class="fas fa-user-md"></i>  Doctors</a></li>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="{{ route('admin.delete_doctor', ['doctor_id' => $doctor->id]) }}" class="btn btn-danger btn-block"><b> <i class=" fas fa-trash-alt"></i> DELETE</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">{{$doctor->mobile }}</p>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="{{ route('admin.update_doctor') }}" method="POST">
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="hospital" class="form-control" @if( $branches->count() == null ) disabled @endif>
                            @foreach($branches as $branch)
                              <option value="{{ $branch->id}}" @if($doctor->location_id == $branch->id) selected @endif> {{ $branch->city }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
